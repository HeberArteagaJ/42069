...
filename_costos = par.Paths['costos']
...
def registro_medicos(lista_medicos):
    ...
    with open(filename_trabajo_medicos, "w", encoding="UTF8") as archive:
        ...
        # Titulos
        titles = "Médico,Bloques Trabajados,Bloques Horas Extra\n"
        archive.write(titles)
        archive.truncate()
...
def registro_costos(lista_costos):

    with open(filename_costos, "w", encoding="UTF8") as archive:
